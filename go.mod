...
replace (
	...
	// Really iavl 0.19.3 + Roman's patch.  Will cut a tag if this solves.
	github.com/cosmos/iavl => github.com/notional-labs/iavl v0.17.3-0.20221015174057-65f41d2d0c86
